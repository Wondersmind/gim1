...
<div class="wrapper">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                       ...
                                       <a class="btn btn-circle btn-icon-only btn-default" id="resrOut" data-toggle="tooltip" title="New">
                                           ...
                                           <a class="btn btn-circle btn-icon-only btn-default" href="javascript:void(0)" data-toggle="confirmation" data-popout="true"  title="Authorization">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="directmainprocess.mm" id="resrOut" data-toggle="tooltip" title="Existing">
						...
						<option value="">Select Location</option>
							  <c:forEach var="ExistStr" items="${ExistStrDet}">
                                ...
                                <div class="col-md-4">
                                <input type="text" class="form-control input-sm dateTimePick" placeholder="Date/Time" id="dateINMainPrcs" disabled>
                                                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-2">
                               ...
                               <select  class="selectpicker"  ${LoginDet.em_emp_typ}  data-live-search="true" data-size="5" id="fromDptOfMainPrcs">
                                <option value="">Select DepartMent</option>
										...
										<%--  <c:choose><c:when test="${dptOfUserLogin[0] eq ExistDpt.dm_dpt_cd}">
 ...
 <span class="input-group-addon ingrdon" id="basic-addon2" ><i class="icon-plus"></i></span>
    ...
    <thead>
      ...
      <th>Trns Typ<input class="form-control input-sm search"></th>
...
if(companysCd)$("#cmyCdOfMainProcsTmp").val(companysCd);
...
<script src="js/tempMainPrcs.js"></script>
