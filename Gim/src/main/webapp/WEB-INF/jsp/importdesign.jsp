            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="portlet-title">
                 <div class="caption"> <i class="icon-social-dribbble font-dark hide"></i> <span class="caption-subject font-dark bold uppercase text-muted page-title-alt">
                        <h4 class="page-title">Import Design</h4>
                 ...
                 <div class="col-md-8" style=" margin-top: 5px; "> 
                         <div class="col-md-4">
                          <select class="selectpicker" id="vendorCd" data-size="5"  data-live-search=true>
                   ...
                   <div class="col-md-4">
 					...
 					<select class="selectpicker"  data-size="5"  data-live-search=true id="selerOfDgn"> 
 					<option value="">Select Seller</option>   
                                       ...
                                       <div class="actions">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default sa" href="javascript:saveaddImportDegsin()" id="resrOut" data-toggle="tooltip" title="Save">
                                                <i class="icon-doc"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" data-toggle="tooltip" title="Delete">
                                                <i class="icon-trash"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="design.mm"  data-toggle="tooltip" title="Existings"> <i class="icon-logout"></i> </a> </div>
                    <div class="actions">
                ...
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Choose File Here..</label>
                  </div>
                      <div class="col-md-4">
                   ...
                   <div class="col-md-2">
                    <button class="btn-change7" type="button"  onclick="jsontoHtmlLoad()">Load Data</button>
                  </div>
                    <div class="col-md-2">
                   <span id="loadingTableSpan"></span>
                  </div>
...
<script src="js/importMaster.js"></script>
<script>
  $(function() {
