      ...
      <ul class="nav navbar-nav navbar-left">
        ...
        <li class="dropdown mega-dropdown active">
          ...
          <ul class="dropdown-menu mega-dropdown-menu row dropwdth">
            ...
            <li class="emplactive"><a href="bom.mm" class="emplactive">BOM</a></li>
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit BOM</h4></span>
                                        </div>
                                 
                                       <div class="actions">
                                            
                                             <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddBomEdit()" id="resrOut" data-toggle="tooltip" title="Save">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="bom.mm" id="resrOut" data-toggle="tooltip" title="Existings">
                                ...
                                <form class="form-horizontal" action="saveBomEdit.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="hidden" name="bm_id" value="${ExistBomEdit.bm_id}">
                                 <input type="hidden" name="bm_bom_crt_dt" value="${ExistBomEdit.bm_bom_crt_dt}">
                                  <input type="hidden" name="bm_bom_crt_id" value="${ExistBomEdit.bm_bom_crt_id}">
                                <input type="text" class="form-control" placeholder="Code" name="bm_bom_cd" value="${ExistBomEdit.bm_bom_cd}" readonly="readonly">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <select class="form-control" name="bm_cmy_cd" required="required">
                                 <option value="">Select Company</option>
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <c:choose><c:when test="${ExistBomEdit.bm_cmy_cd eq ExistCom.cm_cmy_cd}"> <option value="${ExistCom.cm_cmy_cd}" selected="selected">${ExistCom.cm_cmy_nm}</option></c:when>
                               <c:otherwise> <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option></c:otherwise> 
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Name" name="bm_bom_nm" required="required" value="${ExistBomEdit.bm_bom_nm}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">BOM WIP Type</label>
                                </div>
                                <div class="col-md-10">
                                 <input type="text" class="form-control" placeholder="BOM WIP Type" name="bm_bom_wip_typ" value="${ExistBomEdit.bm_bom_wip_typ}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">BOM Size</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Size" name="bm_bom_sz" value="${ExistBomEdit.bm_bom_sz}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Type" name="bm_bom_typ" value="${ExistBomEdit.bm_bom_typ}">
                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="number" step="any" min="0" class="form-control" placeholder="BOM Qty" name="bm_bom_qty" value="${ExistBomEdit.bm_bom_qty}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">BOM Weight</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Weight" name="bm_bom_wgt" value="${ExistBomEdit.bm_bom_wgt}"> 
                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">IS READY BOM</label>
                                </div>
                               <input type="hidden" name="bm_is_rdy_bom" value="${ExistBomEdit.bm_is_rdy_bom}">
                                 <div class="col-md-1">
                                <c:choose><c:when test="${ExistBomEdit.bm_is_rdy_bom eq 'ON'}"> <input type="checkbox" data-offstyle="danger" data-toggle="toggle" data-on="READY" data-off="NOT READY" checked name="pm_prcs_sts"></c:when> 
                                <c:otherwise> <input type="checkbox" data-toggle="toggle" data-on="READY" data-off="NOT READY" data-offstyle="danger" name="pm_prcs_sts"></c:otherwise> </c:choose>
                               
                                </div>
                                </div>
                                 <button type="submit" id="submiterBomEditForm" style="display:none"></button>
                             <!--    <div class="form-group">
...
$(function() {
    ...
    $(":checkbox").change(function(){
    	$("[name=bm_is_rdy_bom]")[0].value=this.checked?"ON":"OFF";
   })
  })
</script>
