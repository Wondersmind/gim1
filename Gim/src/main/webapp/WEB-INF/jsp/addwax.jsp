...
<div class="wrapper">
  <div class="container-fluid">
            ...
            <div class="portlet light bordered ">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add Wax</h4></span>
                                        </div>
                                       <div class="actions">
                                       <a class="btn btn-circle btn-icon-only btn-default" href="javascript:totalfinalsaveWaxOrder()" id="saveWaxButton" data-toggle="tooltip" title="Save">
                                                <i class="icon-doc"></i>
                                            </a>
                                ...
                                <div class="col-md-4">
                                 <select class="selectpicker" data-size="5" data-live-search="true" id="companyCdWax">
   <option value="">Select Company</option>
                                ...
                                <div class="col-md-4">
                                 <select class="selectpicker" data-size="5" data-live-search="true" id="storeCdWax"> 
 <option value="">Select Location</option>
							  <c:forEach var="ExistStr" items="${ExistStrDet}">
                                ...
                                <div class="col-md-4" style="text-align: left;">
                                 <input class="form-control" id="docNoWax" value="${ExistWaxDcoNo}">
                                ...
                                <div class="col-md-4" style="text-align: left;">
                                <input type="text" class="form-control input-sm dateTimePick" id="docDtWax" placeholder="date/time" disabled="disabled">
                                </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                <select class="selectpicker" data-size="5"  data-live-search="true" id="trgtdtId" size="5">
                         					<option value="">Select TargetDate</option>
                                ...
                                <div class="col-md-4">
                               <select class="selectpicker" data-size="5"  data-live-search="true"  multiple data-selected-text-format="count > 3" data-actions-box="true" id="dptCdWax">
                         <option value="">Select DepartMent</option>
                                ...
                                <div class="col-md-4">
                                <select class="selectpicker" data-size="5" data-live-search="true"  multiple data-selected-text-format="count > 3" data-actions-box="true" data-size="7" id="orderNoId">
                           <option value=""> Select Job OrderNo</option>
                          <c:forEach var="addOrdNo" items="${addOrdNoDet}">
                            <option value="${addOrdNo}">${addOrdNo}</option>
                                ...
                                <div class="col-md-4">
                               <select class="selectpicker" data-size="5" id="ohdtypWax" multiple>
							...
							<option>${ExstOrder}</option>
                                ...
                                <div class="col-md-4">
                               <select class="selectpicker" data-size="5" multiple data-actions-box="true" data-live-search="true" id="ctgyOfWax">
                             </select>
                                </div>
                                ...
                                <div class="col-md-4">
                               <select class="selectpicker" data-size="5" data-live-search="true" id="workCdWax">
                               ...
                               <option value="${DeptWrk[0]}">${DeptWrk[1]}</option>
                                ...
                                <div class="col-md-4">
                               <select class="selectpicker" data-size="5"  data-live-search="true"  multiple data-selected-text-format="count > 3" data-actions-box="true" id="caratdisplay">
                         <option value="">Select Carat</option>
                                ...
                                <div class="col-md-4">
                               <select class="selectpicker" data-size="5" id="purity" multiple>
                                ...
                                <div class="col-md-6">
                                <input type="number" step="any" class="form-control input-sm" placeholder="Issued Qty" id="noOfQtyWax" >
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <input type="number" step="any" class="form-control input-sm" placeholder="No of Orders" id="noOfOrdWax">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <input type="number" step="any" class="form-control input-sm" placeholder="Standard Weight" id="sumOfStdWgtWax">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <input type="number" step="any" class="form-control input-sm" placeholder="No of Product" id="sumOfNoPdts">
                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <select class="selectpicker" data-size="5" multiple data-actions-box="true" id="reuseorder">
                               	<option value="Reuse">ReWax</option>
                                <option value="Non Reuse">Non ReWax</option>
                                </select>
                                </div>
                                </div>
                                </div>
    ...
    <thead>
      ...
      <th>Target Date <input class="form-control input-sm"></th>
       <th>Produtct Id <input class="form-control input-sm"></th>
               <th>Qty <input class="form-control input-sm"></th>
        <th>Size <input class="form-control input-sm"></th>
               <th>Category <input class="form-control input-sm"></th>
               <th>StWeight <input class="form-control input-sm"></th>
               <th>StWeight*Qty <input class="form-control input-sm"></th>
         <th>Order Type <input class="form-control input-sm"></th>
      </tr>
    </thead>
    <tbody id="myTbody">
    <c:forEach var="addWaxOrd" items="${addWaxOrdDet}">
      <tr joNo="${addWaxOrd[10]}" dptName="${addWaxOrd[11]}" ${addWaxOrd[12]} carat="${addWaxOrd[13]}" >
...
<script src="js/waxController.js"></script>
