        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <div class="portlet light bordered">
             <c:choose><c:when test="${SaveSucResultAly eq true}">
                 <span id="finalSaveDesinAlert" style="color:green"><div class="alert alert-success" style="text-align: center;">Saved Successfully</div></span>
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Alloying</h4></span>
                                        </div>
                                        <div class="actions">
                                           
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addalloying.mm">
                                                <i class="icon-plus"></i>
                                            </a>
            ...
            <p style="margin-left: 36%;" class="loadClass" id="LoadName"><b>Loading Please Wait...</b></p>
          	...
          	var tables='${ExstAlyPrcDtl}';
               ...
               <%--  <table class="table table-bordered" id="myTable">
                    ...
                    <th>Dcmnt No</th>
                          <th>Tot.Rcvd Wgt</th>
                          <th>Tot.Rcvd Purity</th>
                          <th>Tot.Exptd CnvtWgt</th>
                          <th>Iss Auth</th>
                          <th>Rcvd Auth</th>
                          <th>Action</th>
                        </tr>
                      ...
                      <tbody>
                      <c:forEach var="ExstAlyPrcs" items="${ExstAlyPrcDtl}">
                    <tr>
                     <td>${ExstAlyPrcs[7]}</td>
                          <td>${ExstAlyPrcs[0]}</td>
                          ...
                          <td>${ExstAlyPrcs[5]}</td>
                         <td class="text-right">
                         <c:choose><c:when test="${ExstAlyPrcs[4] eq '0'}">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editAlyPrcHdrDtlById(${ExstAlyPrcs[6]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal"  data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delAlyPrcHdrDtlById(${ExstAlyPrcs[6]},this)"><i class="fa fa-trash-o"></i></button>
									</c:when>
									<c:otherwise>
										<button type="button" style="width:48px" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editAlyPrcHdrDtlById(${ExstAlyPrcs[6]})"><i class="fa fa-pencil"></i></button>
	...
	if(res !=null && res.length>0){
			 ...
			 var tempStorage=res;
				...
				var columns=[
				             ...
				             { field: '7', caption: 'CmyName',type:'text', sortable: true},
		                        { field: '0', caption: 'DocNo',type:'text',sortable: true},
		                        { field: '12', caption: 'Doc.DT',type:'text',sortable: true},
		                        { field: '15', caption: 'Iss.Mtlwgt',type:'float', sortable: true},
		                        { field: '8',caption:'Isd.AlyWgt',type:'float', sortable: true},
		                        { field: '16', caption: 'Mtl.Prty',type:'float', sortable: true},
		                         /* { field: '13', caption: 'Mtl Wt',type:'text',sortable: true},
		                        { field: '14', caption: 'Mtl Pty',type:'text',sortable: true},  */
		                        /* { field: '8',caption:'Isd.Wgt',type:'float', sortable: true}, */
		                        { field: '1',caption:'Rcvd.Wgt',type:'float', sortable: true},
		                        { field: '9', caption: 'Bal.Wgt',type:'text', sortable: true},
		                        { field: '10', caption: 'Conv.Prty',type:'float', sortable: true},
		                        { field: '3', caption: 'Exp.Prty',type:'float', sortable: true},
		                        { field: '2', caption: 'TotRcvdPrty',type:'text', sortable: true},
		                        { field: '4',caption: 'Iss.Auth',type:'text', sortable: true},
		                        { field: '5', caption: 'Rcvd.Auth',type:'text', sortable: true},
		                        { field: '6', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='';
				                            	if(record[4]=='1'){
				                            	html='&nbsp;<button type="button" class="btn btn-xs btn-default btn-equal"  data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editAlyPrcHdrDtlById(\''+record[6]+'\')"><i class="fa fa-pencil"></i></button>';	
				                            	}
				                            	else{
				                            		html='&nbsp;<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editAlyPrcHdrDtlById(\''+record[6]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delAlyPrcHdrDtlById(\''+record[6]+'\',this)"><i class="fa fa-trash-o"></i></button>';
													}
				                            	if(record[11]=='1'&&Number(record[3]||0)>Number(record[2]||0)){
				                            		html+='&nbsp;<button type="button" class="btn btn-xs btn-danger btn-equal"  data-toggle="tooltip" data-placement="top" data-original-title="Rejected Alloy"><i class="fa fa-warning"></i></button>';	
				                            	}
				                            	return html;
				                            } 
				                        }
...
function editAlyPrcHdrDtlById(id){
	window.location.href="editalloyprocess.mm?aly_prcs_id="+id+"";
}

function delAlyPrcHdrDtlById(id,ths){
	$(ths).closest("tr").css("background-color","orangered");
	AjaxController.deleteAlyHdrRecAjax(id,returnResOfDelAlyHdr);
