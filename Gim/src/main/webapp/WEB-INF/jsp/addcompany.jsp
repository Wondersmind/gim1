            ...
            <div class="col-md-12 col-lg-12">
              <div class="portlet light bordered">
                <div class="portlet-title">
                  ...
                  <div class="actions"> 
                  <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddCompany()" id="saveOfCompayBtn" data-toggle="tooltip" title="Save">
                     ...
                     <div class="actions"> 
                    <c:choose><c:when test="${SaveCompanyResult eq true}">
              ...
              <form class="form-horizontal" action="savecompany.mm" method="post" id="saveCompanyFormId">
                <div class="form-group">
                  <div class="col-md-2">
                    <label class="control-label">Code</label>
                  </div>
                  <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Code" required="required" name="cm_cmy_cd" value="${cmyAutoGnId}">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Name" required="required" name="cm_cmy_nm">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Altr Company Name</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Name" name="cm_alt_cmy_nm">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 1" name="cm_rgst_nm1">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Register Number 1</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 1" name="cm_alt_rgst_nm1">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 2" name="cm_rgst_nm2">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Register Number 2</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 2" name="cm_alt_rgst_nm2">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 3" name="cm_rgst_nm3">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Register Number 3</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 3" name="cm_alt_rgst_nm3">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Address 1" name="cm_cmy_ads1">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Address 2</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Address 2" name="cm_cmy_ads2">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="City" name="cm_cmy_cty">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">State</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="State" name="cm_cmy_st">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <select class="form-control" name="cm_cmy_cy">
                      <option></option>
                      <option></option>
                      <option></option>
                    </select>
                  ...
                  <div class="col-md-4">
                    <select class="form-control" name="cm_cmy_cny">
                      <option></option>
                      <option></option>
                      <option></option>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Pin Code" name="cm_cmy_pin_cd" maxlength="6" minlength="6" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Phone Number</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Phone Number" name="cm_cmy_ph_no" onkeypress='return event.charCode >= 48 && event.charCode <= 57'  maxlength="15" minlength="6">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text"  class="form-control" placeholder="Mobile Number" name="cm_cmy_mob_no" maxlength="10" minlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Email</label>
                  </div>
                  <div class="col-md-4">
                    <input type="email" class="form-control" placeholder="Email" name="cm_cmy_eml">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Website" name="cm_cmy_web">
                  </div>
                </div>
                <button style="display:none" type="submit" id="submitterCompanyForm"></button>
                <!--<div class="form-group">
...
$("form").submit(function(event){
	...
	var cmyId=$("input[name='cm_cmy_cd']").val();
	AjaxController.chkThisCmyCdAlrdyPrsntOrNot(cmyId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
				$("#saveOfCompayBtn").addClass("disabled");$("#saveOfCompayBtn").prop("disabled",true);
			document.getElementById("submitterCompanyForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html('<div class="alert alert-danger" id="successfnl215">Company Code Already Exist..</div>');$("#successfnl215").fadeOut(3500);
			$("input[name='cm_cmy_cd']").select();
			$("input[name='cm_cmy_cd']").focus();
			return false;
		}
	}
});
    ...
    function clrInputForAll(){
    	$("input").not("input[name=cm_cmy_cd]").val("");
