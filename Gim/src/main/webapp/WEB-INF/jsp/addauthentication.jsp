            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="portlet-title">
                      <div class="caption"> <i class="icon-social-dribbble font-dark hide"></i> <span class="caption-subject font-dark bold uppercase text-muted page-title-alt">
                        <h4 class="page-title">Add Auth Detail</h4>
                        </span> </div>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label">User Name</label>
                      ...
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="User Name" name="auth_usr_nm" required="required" value="">
                  </div>
                    </div>
                     <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">User Password</label>
                      ...
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="User Password" name="auth_usr_pwd" required="required">
                  </div>
                    </div>
