        ...
        <li class="dropdown mega-dropdown active">
          ...
          <ul class="dropdown-menu mega-dropdown-menu row dropwdth">
            ...
            <li><a href="uom.mm">Uom</a></li>
               <li><a href="daywiseprice.mm">Day Wise Price</a></li>   <li><a href="alloymaster.mm">Alloy</a></li><li class="emplactive"><a href="Carat.mm" >Carat</a></li>
...
<div class="wrapper">
  <div class="container-fluid">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">CARAT Master</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addcarat.mm">
                                                <i class="icon-plus"></i>
                                            </a>
                                          ...
                                          <div class="actions">
                                        <c:choose><c:when test="${SaveBomResult eq true}">
    ...
    <tbody>
     <c:forEach var="exstCrt" items="${ExstCaratMstDtl}">
      <tr>
        <td>${exstCrt.crtm_carat_cd}</td>
        <td>${exstCrt.crtm_carat_nm}</td>
        <td>${exstCrt.crtm_carat_prty}</td>
        <td>${exstCrt.crtm_carat_wgt}</td>
        <td>${exstCrt.crtm_carat_sts}</td>
        <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editCaratMstRec(${exstCrt.crtm_id})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delCaratMstRec(${exstCrt.crtm_id},this)"><i class="fa fa-trash-o"></i></button>
									</td>
      </tr>
      </c:forEach>
		...
		var res=eval(tables);
		 if(res !=null && res.length>0){
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              { field: 'crtm_carat_cd', caption: 'Carat Cd',type:'text',sortable: true}, 
					             { field: 'crtm_carat_nm', caption: 'Carat Name',type:'text', sortable: true},
			                    { field: 'crtm_carat_prty',caption:'Carat Prty',type:'text', sortable: true},
		                        { field: 'crtm_carat_wgt', caption: 'Carat Wgt',type:'text', sortable: true},
		                        { field: 'crtm_carat_sts', caption: 'Carat Sts',type:'text', sortable: true},
		                         { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button ${LoginDet.em_emp_typ} type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editCaratMstRec(\''+record.crtm_id+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button ${LoginDet.em_emp_typ} type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delCaratMstRec(\''+record.crtm_id+'\',this)"><i class="fa fa-trash-o"></i></button>';
...
<script type="text/javascript">
function editCaratMstRec(id){
	location.href="editcarat.mm?carat_id="+id+"";
}
function delCaratMstRec(id,ths){
$(ths).addClass("danger");
	AjaxController.deleteCaratMasterRec(id,rtnDelRes)
function rtnDelRes(rs){
	if(rs=='success'){
