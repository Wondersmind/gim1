        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Location Master</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addstore.mm">
                                                <i class="icon-plus"></i>
                                            </a>
                                        ...
                                        <div class="actions">
                                         <c:choose><c:when test="${SaveStoreEditResult eq true}">
            ...
            <p style="margin-left: 36%;" class="loadClass" id="LoadName"><b>Loading Please Wait...</b></p>
          	...
          	var tables='${existStroeDet}'; </script>
           <%--     <table class="table table-bordered" id="myTable">
                    ...
                    <th>Code</th>
                      ...
                      <tbody>
                   <c:forEach var="existStr" items="${existStroeDet}">
                    <tr>
                          <td>${existStr[0]}</td>
                          <td>${existStr[1]}</td>
                          <td>${existStr[2]}</td>
                          ...
                          <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editStoreMstRec(${existStr[13]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delStoreMstRec(${existStr[13]},this)"><i class="fa fa-trash-o"></i></button>
									</td>
                        </tr>
                        </c:forEach>
                  </tbody>
		...
		var res=eval(tables);
		 if(res !=null && res.length>0){
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              { field: '0', caption: 'Code',type:'text',sortable: true}, 
					             { field: '1', caption: 'Cmy Nm',type:'text', sortable: true},
			                    { field: '2',caption:'Loc Nm',type:'text', sortable: true},
		                        ...
		                        { field: '7', caption: 'Country',type:'text', sortable: true},
		                        { field: '8', caption: 'Currency',type:'text', sortable: true},
		                        { field: '9', caption: 'PinCd',type:'text', sortable: true},
		                        { field: '10', caption: 'Ph.No',type:'text', sortable: true},
		                        { field: '11', caption: 'Mob.No',type:'text', sortable: true},
		                        { field: '12', caption: 'Email',type:'text', sortable: true},
		                       { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editStoreMstRec(\''+record[13]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delStoreMstRec(\''+record[13]+'\',this)"><i class="fa fa-trash-o"></i></button>';
