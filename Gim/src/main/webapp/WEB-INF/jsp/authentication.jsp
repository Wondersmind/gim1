            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="portlet-title">
                      <div class="caption"> <i class="icon-social-dribbble font-dark hide"></i> <span class="caption-subject font-dark bold uppercase text-muted page-title-alt">
                        <h4 class="page-title">Auth Master</h4>
                        </span> </div>
                      <div class="actions"> <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut"> <i class="icon-magnifier-remove"></i> </a> <a class="btn btn-circle btn-icon-only btn-default" href="addauthentication.mm"> <i class="icon-plus"></i> </a> 
                    <!--<a class="btn btn-circle btn-icon-only btn-default" href="javascript:;">
                                                <i class="icon-trash"></i>
                                            </a>--> 
                  </div>
                  <div class="actions"> 
                    <c:choose><c:when test="${SaveAuthEditResult eq true}">
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              ...
				              { field: '0', caption: 'Cmy Name',type:'text',sortable: true},
		                        { field: '1',caption:'User Name',type:'text', sortable: true},
		                        { field: '2', caption: 'Password',type:'text', sortable: true},
		                       { field: '3', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editAuthMstRec(\''+record[3]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delAuthMstRec(\''+record[3]+'\',this)"><i class="fa fa-trash-o"></i></button>';
...
function editAuthMstRec(id){
	window.location.href="editauthentication.mm?authid="+id+"";
}
function delAuthMstRec(id,ths){
	$(ths).closest("tr").css("background-color","lightskyblue");
	AjaxController.delAuthMstRecImpl(id,retJobOrdIssCstHdr);
