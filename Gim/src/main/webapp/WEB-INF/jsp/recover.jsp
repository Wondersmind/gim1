    ...
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <div class="panel panel-default">
          ...
          <c:choose><c:when test="${savedResOfRvcyPrcsShow eq true}">
                 <span id="finalSaveDesinAlert" style="color:green"><div class="alert alert-success" style="text-align:center;">Saved Successfully</div></span>
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Recovery</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addrecover.mm">
                                                <i class="icon-plus"></i>
                                            </a>
			 ...
			 var tempStorage=res;
				...
				var columns=[
				             { field: '0', caption: 'Cmy Nm',type:'text', sortable: true},
		                        ...
		                        { field: '7',caption:'Wrk Type',type:'text', sortable: true},
		                        { field: '2',caption:'Wrk Nm',type:'text', sortable: true},
		                        { field: '3', caption: 'Doc No',type:'text', sortable: true},
		                        { field: '10', caption: 'Doc Dt',type:'text', sortable: true},
		                        { field: '4',caption: 'Tot Pure GOld',type:'float', sortable: true},
		                        /* { field: '5', caption: 'Tot Recvy Mtl',type:'float', sortable: true}, */
		                        { field: '5', caption: 'Convt.Wgt',type:'float', sortable: true},
		                        { field: '6', caption: 'Bal Wgt',type:'text', sortable: true},
		                        /* { field: '11', caption: 'Purity',type:'text', sortable: true}, */
		                        { field: '11', caption: 'Mtl.Purity',type:'text', sortable: true},
		                       { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" style="width: 48px !important;" class="btn btn-xs btn-default btn-equal"  data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editrecvyprcs(\''+record[3]+'\')"><i class="fa fa-pencil"></i></button>';	
				                            	return html;
				                            } 
				                        }
				                    ];
...
setTimeout(()=>{
    ...
    function editrecvyprcs(dcno){
    	window.location.href="editrecover.mm?rh_doc_nm="+dcno+"";
    }
