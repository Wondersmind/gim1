            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit Day Wise Price</h4></span>
                                        </div>
                                           
                                       <div class="actions">
                                            
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddDayEdit()" id="resrOut" data-toggle="tooltip" title="Save">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="daywiseprice.mm" id="resrOut" data-toggle="tooltip" title="Existings">
                                ...
                                <form class="form-horizontal" action="saveDayWiseEdit.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Company Name</label>
                                </div>
                                <div class="col-md-10">
                                <input type="hidden" name="dw_pm_id" value="${ExistDayEdit.dw_pm_id}">
                                <input type="hidden" name="dw_pm_crt_dt" value="${ExistDayEdit.dw_pm_crt_dt}">
                                <input type="hidden" name="dw_pm_crt_id" value="${ExistDayEdit.dw_pm_crt_id}">
                                <select class="form-control" name="dw_pm_cmy_cd" required="required">
                               <option value="">Select Company</option>
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <c:choose><c:when test="${ExistDayEdit.dw_pm_cmy_cd eq ExistCom.cm_cmy_cd}">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control datepicker" placeholder="To Date" name="dw_pm_tdy_dt" value="${ExistDayEdit.dw_pm_tdy_dt}" autocomplete="off" disabled="disabled">
                                </div>
                                </div>
                                  <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Gold Carat</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Gold Carat" name="dw_pm_gld_carat" value="${ExistDayEdit.dw_pm_gld_carat}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Purity" name="dw_pm_pty" value="${ExistDayEdit.dw_pm_pty}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="number" step="any" class="form-control" placeholder="Price" name="dw_pm_prc" value="${ExistDayEdit.dw_pm_prc}">
                                </div>
                                </div>
                                  <button style="display:none" type="submit" id="submitterDayEditForm"></button>
                                <!--<div class="form-group">
