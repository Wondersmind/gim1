            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">BOM Master</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addbom.mm">
                                                <i class="icon-plus"></i>
                                            </a>
                                         ...
                                         <div class="actions">
                                        <c:choose><c:when test="${SaveBomEditResult eq true}">
     ...
     <c:forEach var="exstBom" items="${exstBomdetal}">
      <tr>
        ...
        <!--<td><label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                     ...
                                                     <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editBomMstRec(${exstBom[7]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delBomMstRec(${exstBom[7]},this)"><i class="fa fa-trash-o"></i></button>
									</td>
      </tr>
      </c:forEach>
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              { field: '0', caption: 'Cmy Name',type:'text',sortable: true}, 
			                    ...
			                    { field: '2',caption:'Bom Name',type:'text', sortable: true},
		                        { field: '3', caption: 'Bom Wrk Type',type:'text', sortable: true},
		                        { field: '4', caption: 'Bom Size',type:'text', sortable: true},
		                        { field: '5', caption: 'Bom Type',type:'text',sortable: true}, 
		                        { field: '9', caption: 'Bom Qty',type:'text',sortable: true}, 
		                        { field: '8', caption: 'Bom Wgt',type:'text',sortable: true}, 
					           { field: '6', caption: 'Status',type:'text', sortable: true},
		                        { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editBomMstRec(\''+record[7]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delBomMstRec(\''+record[7]+'\',this)"><i class="fa fa-trash-o"></i></button>';
