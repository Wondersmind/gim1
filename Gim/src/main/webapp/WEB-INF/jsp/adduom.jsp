            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add UOM</h4></span>
                                        </div>
                                       
                                       <div class="actions">
                                           
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddUom()" id="saveOfUomHBtn" data-toggle="tooltip" title="Save">
                                                <i class="icon-doc"></i>
                                            </a>
                                          ...
                                          <div class="actions">
                                         <c:choose><c:when test="${SaveUomResult eq true}">
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveUom.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Code" name="um_uom_cd" required="required" value="${uomAutoGnId}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                              ...
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Name" name="um_uom_nm" required="required">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <textarea class="taxtare" placeholder="Description" name="um_uom_dscr"></textarea>
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <input type="checkbox" checked data-toggle="toggle" data-on="Enabled" data-off="Disabled" name="um_uom_sts">
                                 ...
                                 <button style="display:none" type="submit" id="submitterUomForm"></button>
                                <!--<div class="form-group">
...
function clrInputForAll(){
	$("input,select,textarea").not("input[name=um_uom_cd]").val("");
...
$("form").submit(function(event){
	...
	var cmyId=$("input[name='um_uom_cd']").val();
	AjaxController.chkThisUomCdAlrdyPrsntOrNot(cmyId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
				$("#saveOfUomHBtn").addClass("disabled");$("#saveOfUomHBtn").prop("disabled",true);
			document.getElementById("submitterUomForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html(("UomCode Already Used.").fontcolor("red"));
			$("input[name='um_uom_cd']").select();
			$("input[name='um_uom_cd']").focus();
			return false;
		}
	}
});	
