            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="portlet-title">
                      <div class="caption"> <i class="icon-social-dribbble font-dark hide"></i> <span class="caption-subject font-dark bold uppercase text-muted page-title-alt">
                        <h4 class="page-title">Add Mold</h4>
                        </span> </div>
                          
                                       <div class="actions">
                                           
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddMold()" id="saveOfMoldHBtn" data-toggle="tooltip" title="Save">
                                                <i class="icon-doc"></i>
                                            </a>
                    ...
                    <div class="actions">
                           <c:choose><c:when test="${SaveMoldResult eq true}">
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                  ...
                  <form class="form-horizontal" action="saveMold.mm" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label">Mold No</label>
                      ...
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Mold No" name="mm_mold_no" required="required" value="${moldCdAutoGnId}">
                  </div>
                    </div>
                     <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Available Qty</label>
                      ...
                      <div class="col-md-10">
                    <input type="number" class="form-control" placeholder="Available Qty" name="mm_mold_qty" step="any" min="0">
                  </div>
                    </div>
                    ...
                    <label class="control-label">Unit Reqd</label>
                      ...
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Unit Reqd" name="mm_mold_un_rq" >
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Description</label>
                      ...
                      <div class="col-md-10">
                    <textarea class="taxtare" placeholder="Description" name="mm_mold_dscr"></textarea>
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    ...
                    <div class="input-group image-preview">
                      ...
                      <div class="image-preview-input bnbgclr"> <span class="glyphicon glyphicon-picture"></span> <span class="image-preview-input-title">Choose Image</span>
                            <input type="file" accept="image/png, image/jpeg, image/gif" name="mm_file" id="filese">
                            <!-- rename it --> 
                          </div>
                      </span> </div>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label">Other 1</label>
                      ...
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Other 1" name="mm_mold_othr1">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Other 2</label>
                      ...
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Other 2" name="mm_mold_othr2">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    ...
                    <input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled" checked name="mm_mold_sts">
                      ...
                      <button style="display:none" type="submit" id="submitterMoldForm"></button>
                <!--<div class="form-group">
...
function clrInputForAll(){
	$("input,select,textarea").not("input[name=mm_mold_no]").val("");
...
$("form").submit(function(event){
	...
	var cmyId=$("input[name='mm_mold_no']").val();
	AjaxController.chkThisMoldCdAlrdyPrsntOrNot(cmyId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
				$("#saveOfMoldHBtn").addClass("disabled");$("#saveOfMoldHBtn").prop("disabled",true);
			document.getElementById("submitterMoldForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html(("MoldNo Already Used.").fontcolor("red"));
			$("input[name='mm_mold_no']").select();
			$("input[name='mm_mold_no']").focus();
			return false;
		}
	}
});
