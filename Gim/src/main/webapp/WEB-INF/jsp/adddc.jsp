    ...
    <div class="row">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add DC</h4></span>
                                        </div>
                                       <div class="actions">
 	...
 	<option value="">Select Location</option>
							  <c:forEach var="ExistStr" items="${ExistStrDet}">
                                ...
                                <div class="col-md-4">
                                <input type="text" class="form-control input-sm" placeholder="DC Number" id="dcNumberINDcPrcs" value="${AutoIdForSubPrcs}">
                                                               </div>
                                                                  <div class="col-md-2">
                                <label class="control-label">Date/Time</label>
                                </div>
                                <div class="col-md-4">
                                <input type="text" class="form-control input-sm dateTimePick" placeholder="Date/Time" id="dateINDcPrcs" disabled="disabled">
                                ...
                                <div class="col-md-4">
                                <select class="selectpicker"  ${LoginDet.em_emp_typ}  data-live-search="true" id="dptCdOfDcPrcs">
 							 ...
 							 <option value="ComWrker">company worker</option>
                                ...
                                <div class="col-md-2">
                                <label class="control-label">Worker Name <i class="glyphicon glyphicon-filter" aria-hidden="true" data-original-title="" title=""></i></label>
                                </div>
                                <div class="col-md-4">
                                <span inworker>
                     ...
                     <%-- 	<c:forEach var="ExistVn" items="${ExistVnDet}">
                               ...
                               <div class="col-md-2">
                                <label class="control-label">Bal Stock</label>
                                </div>
                                <div class="col-md-4">
                               <input class="form-control" id="balStockWrkInDc" readonly>
                                ...
                                <div class="col-md-6">
                                <input type="text" class="form-control input-sm" placeholder="Issued Wgt" id="IsdWgtOfDc">
                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <input type="text" class="form-control input-sm" placeholder="Fnsh Wgt" id="fnshWgtOfDc">
                                </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                <input type="text" class="form-control input-sm" placeholder="Scrp Wgt" id="scrpWgtOfDc">
                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <input type="text" class="form-control input-sm" placeholder="Received Weight" id="rcvdWgtOfDc">
                                </div>
                                </div>
                            <div class="form-group">
                                 <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <input type="text" class="form-control input-sm balWGtOfHdr" placeholder="Bal Wgt">
                                </div>
                                </div>
...
<div class="modal fade" id="sampleIssuerForDc" role="dialog">
   ...
   <tr><th>ISDWGT</th><th>SMPNO</th><th>ISD SMPL</th><th>RCVD SMPL</th><th>RCVD PRTY</th></tr></thead>
    <tbody id="IsdSampleTbody">
        ...
        <button type="button" class="btn btn-success btn-sm" id="saveDctestSmplIsud">Save</button>
...
<div class="modal fade" id="tranModel" role="dialog">
    ...
    <tr><th>TRNS_NO</th><th>TRNS_TYP</th><th>FROM_DPT</th><th>PRTY</th><th>ISDWGT</th><th>FNSH_PDT</th><th>SCRP MTL</th><th>MTL RCVD</th><th>PG WGT</th><th>TOT_RCVD</th></tr>
    </thead>
    <tbody id="tranTbody">
 </tbody>  
    </table></div></div>
...
window.adminId='${LoginDet.em_emp_id}';
	...
	if(companysCd)$("#fromCmpnyOfDcPrcs").val(companysCd);
	if(storeCd)$("#strCdOfDcProcsTmp").val(storeCd);
	if(depty)$("#dptCdOfDcPrcs").val(depty.split(",")[0])
</script>
...
<script src="js/bootstrap-select.min.js"></script>
   <script src="js/datatableSMR.js"></script>
     <script src="js/adddcController.js"></script>
...
<input type="hidden" id="loginempcd" value="${loginempcd}">
</body>
</html>