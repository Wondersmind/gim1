            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add Raw Metrial</h4></span>
                                        </div>
                                         
                                       <div class="actions">
                                           
                                             <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddRaw()"  id="saveORawMtrHBtn" data-toggle="tooltip" title="Save">
                                         ...
                                         <div class="actions">
                                           <c:choose><c:when test="${SaveRawResult eq true}">
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveRawMaterial.mm" method="post">
                              ...
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Product Id" name="rm_mst_pdt_id" required="required" value="${rwMtrlCdAutoGnId}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Product Name" name="rm_mst_pdt_nm">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Purity" name="rm_mst_pdt_pty">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                              <input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled" checked name="rm_mst_sts">
                                </div>
                                </div>
                                
                                   <button style="display:none" type="submit" id="submitterRawForm"></button>
                               <!-- <div class="form-group">
...
function clrInputForAll(){
	$("input,select,textarea").not("input[name=rm_mst_pdt_id]").val("");
...
$("form").submit(function(event){
	...
	var cmyId=$("input[name='rm_mst_pdt_id']").val();
	AjaxController.chkThisRwMtrCdAlrdyPrsntOrNot(cmyId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
				$("#saveORawMtrHBtn").addClass("disabled");$("#saveORawMtrHBtn").prop("disabled",true);
			document.getElementById("submitterRawForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html(("ProductCode Already Used.").fontcolor("red"));
			$("input[name='rm_mst_pdt_id']").select();
			$("input[name='rm_mst_pdt_id']").focus();
			return false;
		}
	}
});
