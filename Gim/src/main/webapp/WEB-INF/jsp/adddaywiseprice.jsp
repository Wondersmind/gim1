            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add Day Wise Price</h4></span>
                                        </div>
                                           
                                       <div class="actions">
                                            
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddDay()" id="saveOfDyWsBtn" data-toggle="tooltip" title="Save">
                                        ...
                                        <div class="actions">
                                           <c:choose><c:when test="${SaveDayResult eq true}">
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveDayWise.mm" method="post">
                              ...
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control datepicker" placeholder="To Date" name="dw_pm_tdy_dt" autocomplete="off" value="${CurrentDate}" disabled="disabled">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Purity" name="dw_pm_pty">
                                </div>
                                </div>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Gold Carat" name="dw_pm_gld_carat">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Price" name="dw_pm_prc">
                                </div>
                                </div>
                                  <button style="display:none" type="submit" id="submitterDayForm"></button>
                                <!--<div class="form-group">
...
function clrInputForAll(){
	$("input,select,textarea").not("input[name=dw_pm_tdy_dt]").val("");
...
$("form").submit(function(event){
	$("#saveOfDyWsBtn").addClass("disabled");$("#saveOfDyWsBtn").prop("disabled",true);
});
