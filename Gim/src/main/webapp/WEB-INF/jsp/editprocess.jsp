            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit Process</h4></span>
                                        </div>
                                       <div class="actions">
                                          
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddProcessEdit()" id="resrOut" data-toggle="tooltip" title="Save">
                                ...
                                <form class="form-horizontal" action="saveProcessEdit.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Code" name="pm_prcs_cd" readonly="readonly" value="${ExistPrcsEdit.pm_prcs_cd}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                              ...
                              <c:choose><c:when test="${ExistPrcsEdit.pm_cmy_cd eq ExistCom.cm_cmy_cd}">  <option value="${ExistCom.cm_cmy_cd}" selected="selected">${ExistCom.cm_cmy_nm}</option></c:when> 
                             <c:otherwise>  <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option></c:otherwise> </c:choose>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Name" required="required" name="pm_prcs_nm" value="${ExistPrcsEdit.pm_prcs_nm}">
                                <input type="hidden" name="pm_id" value="${ExistPrcsEdit.pm_id}">
                                 <input type="hidden" name="pm_prcs_crt_dt" value="${ExistPrcsEdit.pm_prcs_crt_dt}">
                                  <input type="hidden" name="pm_prcs_crt_id" value="${ExistPrcsEdit.pm_prcs_crt_id}">
                                </div>
                                </div>
                                  <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="form-group">
                                 ...
                                 window.prcs=('${ExistPrcsEdit.pm_dpt_cd}').split(",");
                                </script>
                                <label class="control-label">Department</label>
                                </div>
                                <div class="col-md-10">
                                <select class="selectpicker" multiple id="dptprcs" data-live-search="true" name="pm_dpt_cd">
                                ...
                                <div class="col-md-10">
                                <textarea class="taxtare" placeholder="Description" name="pm_prcs_dscr">${ExistPrcsEdit.pm_prcs_dscr}</textarea>
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <c:choose><c:when test="${ExistPrcsEdit.pm_prcs_sts eq true}"> <input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled" checked name="pm_prcs_sts"></c:when> 
                                <c:otherwise> <input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled" name="pm_prcs_sts"></c:otherwise> </c:choose>
                               
                                </div>
                                </div>
                                   <button style="display:none" type="submit" id="submitterProcessEditForm"></button>
                                <!--<div class="form-group">
...
<script type="text/javascript">
$("#dptprcs").val(prcs);
var prcsType='${ExistPrcsEdit.pm_prcs_typ}';
if(prcsType)$("[name=pm_prcs_typ]").val(prcsType);
</script>
