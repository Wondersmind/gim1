  ...
  <div class="container-fluid">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Uom Master</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="adduom.mm">
                                                <i class="icon-plus"></i>
                                            </a>
                                         ...
                                         <div class="actions">
                                         <c:choose><c:when test="${SaveUomEditResult eq true}">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${existUom[4]}</td>
                                                 <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editUomMstRec(${existUom[5]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delUomMstRec(${existUom[5]},this)"><i class="fa fa-trash-o"></i></button>
									</td>
      </tr>
</c:forEach>
    </tbody>
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              { field: '0', caption: 'Cmy Name',type:'text',sortable: true}, 
			                    ...
			                    { field: '2',caption:'Uom Name',type:'text', sortable: true},
		                       { field: '3', caption: 'Uom Desc',type:'text',sortable: true}, 
					           { field: '4', caption: 'Status',type:'text', sortable: true},
		                        { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editUomMstRec(\''+record[5]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delUomMstRec(\''+record[5]+'\',this)"><i class="fa fa-trash-o"></i></button>';
...
$(document).ready(function(){
	...
	$("#example_paginate").prependTo('#example_wrapper');
