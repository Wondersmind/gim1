            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add CARAT</h4></span>
                                        </div>
                                       ...
                                       <div class="actions">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="carat.mm" id="resrOut" data-toggle="tooltip" title="Existings">
                 ...
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveCarat.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Code</label>
                                </div>
                                <div class="col-md-8">
                                <label  class="control-label" >${bomAutoGnId}</label>
                                <input type="hidden" name="crtm_carat_cd" value="${bomAutoGnId}">
                                </div>
                                </div>
                          
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Carat Name</label>
                                </div>
                                <div class="col-md-8">
                                <input type="text" class="form-control" placeholder="Carat Name" name="crtm_carat_nm" required="required">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Carat Purity</label>
                                </div>
                                <div class="col-md-8">
                                 <input type="text" class="form-control" placeholder="Carat Purity" name="crtm_carat_prty" required="required">
                                </div>
                                </div>
                         		  <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Carat Color</label>
                                </div>
                                <div class="col-md-8">
                                 <input type="color" class="form-control" placeholder="Carat Purity" name="crtm_carat_clr" required="required">
                                </div>
                                </div>
                         		
                         	 <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Carat wgt</label>
                                </div>
                                <div class="col-md-8">
                                 <input type="text" class="form-control" placeholder="Carat wgt" name="crtm_carat_wgt" required="required">
                                </div>
                                </div>
