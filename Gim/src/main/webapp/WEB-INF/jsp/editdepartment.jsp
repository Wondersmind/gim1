        ...
        <li class="dropdown mega-dropdown active">
          ...
          <ul class="dropdown-menu mega-dropdown-menu row dropwdth">
            <li class="col-sm-6">
              ...
              <li class="emplactive"><a href="department.mm" class="emplactive">Department</a></li>
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit Department</h4></span>
                                        </div>
                                   
                                       <div class="actions">
                                            
                                             <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddDepartMentEdit()" id="resrOut" data-toggle="tooltip" title="Save">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="department.mm" id="resrOut" data-toggle="tooltip" title="Existings">
                                ...
                                <form class="form-horizontal" action="saveDepartmentEdit.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Code" name="dm_dpt_cd" value="${ExistDptDtl.dm_dpt_cd}" readonly="readonly">
                              <input type="hidden" name="dm_id" value="${ExistDptDtl.dm_id}"> 
                              <input type="hidden" name="dm_crt_dt" value="${ExistDptDtl.dm_crt_dt}"> 
                              <input type="hidden" name="dm_crt_id" value="${ExistDptDtl.dm_crt_id}"> 
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                               <select class="form-control" name="dm_cmy_cd" required="required">
                               <option value="">Select Company</option>
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                              <c:choose><c:when test="${ExistDptDtl.dm_cmy_cd eq ExistCom.cm_cmy_cd}">
                               ...
                               <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Name" required="required" name="dm_dpt_nm" value="${ExistDptDtl.dm_dpt_nm}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <textarea class="taxtare" placeholder="Description" name="dm_dscr" >${ExistDptDtl.dm_dscr}</textarea>
                                </div>
                                </div>
                                <div class="form-group">
                                <div class="col-md-2">
                                 <label class="control-label">Finishing Prdt</label>
                                </div>
                                <div class="col-md-10">
                                <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                <c:choose>
                                <c:when test="${ExistDptDtl.dm_is_fns eq true}">
                                                        <input type="checkbox" class="checkboxes" name="dm_is_fns" checked>
                                                        </c:when><c:otherwise> <input type="checkbox" class="checkboxes" name="dm_is_fns" ></c:otherwise>
                                </c:choose>
                                                        <span></span>
                                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">IS OUTWARD DPT</label>
                                </div>
                                <div class="col-md-10">
                                 <input type="checkbox" name="dm_sts" checked style="display:none;">
                                <input type="hidden" name="dm_iss_outwd" id="dm_iss_outwd" value="${ExistDptDtl.dm_iss_outwd}">
                                 
                                  <c:choose>
                                <c:when test="${ExistDptDtl.dm_iss_outwd eq 'YES'}">
                                                     <input type="checkbox" checked data-offstyle="danger" data-toggle="toggle" onchange="if(this.checked)$('#dm_iss_outwd').val('YES');else $('#dm_iss_outwd').val('NO');" data-on="YES"  data-off="NOT" >
                              </c:when><c:otherwise>  <input type="checkbox" data-offstyle="danger" data-toggle="toggle" onchange="if(this.checked)$('#dm_iss_outwd').val('YES');else $('#dm_iss_outwd').val('NO');" data-on="YES"  data-off="NOT" ></c:otherwise>
                                </c:choose>
                              
                                </div>
                                </div>
                                 <button type="submit" id="submiterDepartMentEditForm" style="display:none"></button>
                                <!--<div class="form-group">
