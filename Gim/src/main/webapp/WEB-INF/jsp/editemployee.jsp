            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit Employee</h4></span>
                                        </div>
                                      <div class="actions">
                                            
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddEmpEdit()" id="resrOut" data-toggle="tooltip" title="Save">
                                ...
                                <form class="form-horizontal" action="saveEmpEdit.mm" method="post" id="submitterEmpEditForm">
                                ...
                                <div class="col-md-4">
                                  <input type="hidden" name="em_id" value="${ExistEmpDtl.em_id}">
                                <input type="hidden" name="em_emp_id" value="${ExistEmpDtl.em_emp_id}">
                                 <input type="hidden" name="em_emp_crt_dt" value="${ExistEmpDtl.em_emp_crt_dt}">
                                  <input type="hidden" name="em_emp_crt_id" value="${ExistEmpDtl.em_emp_crt_id}">
                                  <input type="hidden" id="dptOfMultiple" value="${ExistEmpDtl.em_dpt_cd}">
                                <select class="form-control" name="em_cmy_cd" required="required">
                                <option value="">Select Company</option>
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                              <c:choose><c:when test="${ExistEmpDtl.em_cmy_cd eq ExistCom.cm_cmy_cd}"><option value="${ExistCom.cm_cmy_cd}" selected="selected">${ExistCom.cm_cmy_nm}</option></c:when>
                              <c:otherwise>  <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option></c:otherwise> </c:choose>
                                ...
                                <c:forEach var="ExistStr" items="${ExistStrDet}">
										<c:choose><c:when test="${ExistEmpDtl.em_str_cd eq ExistStr.sm_str_cd}"><option value="${ExistStr.sm_str_cd}" selected="selected">${ExistStr.sm_str_nm}</option></c:when><c:otherwise><option value="${ExistStr.sm_str_cd}">${ExistStr.sm_str_nm}</option></c:otherwise> </c:choose>
										  </c:forEach>
                                </select>
                                </div>
                                </div>
                                ...
                                <div class="col-md-10">
                                <select class="selectpicker" id="dptOfEmpl" data-live-search="true" multiple data-selected-text-format="count > 3" name="em_dpt_cd" data-actions-box="true"  required="required">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Name" name="em_emp_nm" required="required" value="${ExistEmpDtl.em_emp_nm}" >
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Mobile Number" name="em_emp_mob" minlength="10" maxlength="10" value="${ExistEmpDtl.em_emp_mob}" onkeypress='return event.charCode >= 48 && event.charCode <= 57' >
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="email" class="form-control" placeholder="Email" name="em_emp_eml" value="${ExistEmpDtl.em_emp_eml}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Login" name="em_emp_login_nm" required="required" value="${ExistEmpDtl.em_emp_login_nm}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Password" name="em_emp_login_pwd" required="required" value="${ExistEmpDtl.em_emp_login_pwd}" minlentgh="6">
                                </div>
                                </div>
                                <div class="form-group">
                                  <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <select class="form-control" id="empTypss" name="em_emp_typ" required="required">
                                ...
                                var wrksnm='${ExistEmpDtl.em_emp_typ}';
                                document.getElementById("empTypss").value=wrksnm;
                                </script>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Allowed Qty" name="em_emp_alw_qty" value="${ExistEmpDtl.em_emp_alw_qty}">
                                </div>
                                </div>
...
if($("#dptOfMultiple").val()!=""){
	var dpt=$("#dptOfMultiple").val().split(",");
	$('#dptOfEmpl').val(dpt);
}
});
