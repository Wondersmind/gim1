    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-3">
        ...
        <li class="dropdown mega-dropdown active"> <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Masters</a>
            ...
            <li class="col-sm-6">
                ...
                <li  class="emplactive"><a href="vendor.mm"  class="emplactive">Vendor</a></li>
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="portlet-title">
                      <div class="caption"> <i class="icon-social-dribbble font-dark hide"></i> <span class="caption-subject font-dark bold uppercase text-muted page-title-alt">
                        <h4 class="page-title">Edit Vendor/Customer</h4>
                        </span> </div>
                      <div class="actions"> 
                      <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddVendorEdit()" id="resrOut" data-toggle="tooltip" title="Save">
                                                <i class="icon-doc"></i>
                                            </a>
                      <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" data-toggle="tooltip" title="Delete!"> <i class="icon-trash"></i> </a> 
                  ...
                  <form class="form-horizontal" action="saveVendorEdit.mm" method="post">
                <div class="form-group" >
                      <div class="col-md-2">
                    <label class="control-label">Code</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Code" name="vcm_vnct_cd" readonly="readonly" value="${ExistVntEdit.vcm_vnct_cd}">
                    <input type="hidden" name="vcm_id" value="${ExistVntEdit.vcm_id}">
                    <input type="hidden" name="vcm_vnct_crt_dt" value="${ExistVntEdit.vcm_vnct_crt_dt}">
                    <input type="hidden" name="vcm_vnct_crt_id" value="${ExistVntEdit.vcm_vnct_crt_id}">
                   ...
                   <div class="col-md-2">
                    <label class="control-label">Dept Name</label>
                      ...
                      <div class="col-md-4">
                    <select class="selectpicker" multiple id="vendorDpt" data-live-search="true" name="vcm_dpt_cd">
                  ...
                  window.detpLi='${ExistVntEdit.vcm_dpt_cd}';
                  </script>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    ...
                    <select class="form-control" name="vcm_cmy_cd" required="required">
                       <option value="">Select Company</option>
                              ...
                              <c:choose><c:when test="${ExistVntEdit.vcm_cmy_cd eq ExistCom.cm_cmy_cd}"><option value="${ExistCom.cm_cmy_cd}" selected="selected">${ExistCom.cm_cmy_nm}</option></c:when>
                    ...
                    <label class="control-label">Location Name</label>
                      ...
                      <div class="col-md-4">
                    <select class="selectpicker" data-live-search="true" multiple data-selected-text-format="count > 3"  name="vcm_str_cd" required="required">
                         <option value="">Select Location</option>
                                <c:forEach var="ExistStr" items="${ExistStrDet}">
                                <c:choose><c:when test="${ExistVntEdit.vcm_str_cd eq ExistStr.sm_str_cd}"> <option value="${ExistStr.sm_str_cd}" selected="selected">${ExistStr.sm_str_nm}</option></c:when>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" required="required"  name="vcm_vnct_typ">
                          <c:choose><c:when test="${ExistVntEdit.vcm_vnct_typ eq 'Vendor'}"><option value="Vendor" selected="selected">Vendor</option></c:when><c:otherwise><option value="Vendor">Vendor</option></c:otherwise> </c:choose>
                            <c:choose><c:when test="${ExistVntEdit.vcm_vnct_typ eq 'Customer'}"> <option value="Customer" selected="selected">Customer</option></c:when><c:otherwise> <option value="Customer">Customer</option></c:otherwise> </c:choose>
                              <c:choose><c:when test="${ExistVntEdit.vcm_vnct_typ eq 'Both'}"> <option value="Both" selected="selected">Both</option></c:when><c:otherwise> <option value="Both">Both</option></c:otherwise> </c:choose>
                       </select>
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Vendor Name</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Name" required="required" name="vcm_vnct_nm" value="${ExistVntEdit.vcm_vnct_nm}">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Register Name 1</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 1" name="vcm_vnct_rgst_nm1" value="${ExistVntEdit.vcm_vnct_rgst_nm1}">
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Register Number 1</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 1" name="vcm_vnct_alt_rgst_nm1" value="${ExistVntEdit.vcm_vnct_alt_rgst_nm1}">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Register Name 2</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 2" name="vcm_vnct_rgst_nm2"  value="${ExistVntEdit.vcm_vnct_rgst_nm2}">
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Register Number 2</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 2" name="vcm_vnct_alt_rgst_nm2" value="${ExistVntEdit.vcm_vnct_alt_rgst_nm2}">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Register Name 3</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 3" name="vcm_vnct_rgst_nm3" value="${ExistVntEdit.vcm_vnct_rgst_nm3}">
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Register Number 3</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 3" name="vcm_vnct_alt_rgst_nm3" value="${ExistVntEdit.vcm_vnct_alt_rgst_nm3}">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Address 1</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Address 1" name="vcm_vnct_ads1" value="${ExistVntEdit.vcm_vnct_ads1}">
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Address 2</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Address 2" name="vcm_vnct_ads2" value="${ExistVntEdit.vcm_vnct_ads2}">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">City</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="City" name="vcm_vnct_cty" value="${ExistVntEdit.vcm_vnct_cty}">
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">State</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="State" name="vcm_vnct_st" value="${ExistVntEdit.vcm_vnct_st}">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Country</label>
                      ...
                      <div class="col-md-4">
                    <select class="form-control" name="vcm_vnct_cy" value="${ExistVntEdit.vcm_vnct_cy}">
                          <option></option>
                          <option></option>
                          <option></option>
                        </select>
                    ...
                    <label class="control-label">Currency</label>
                      ...
                      <div class="col-md-4">
                    <select class="form-control" name="vcm_vnct_cny" value="${ExistVntEdit.vcm_vnct_cny}">
                          <option></option>
                          <option></option>
                          <option></option>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label">Pin Code</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Pin Code" minlength="6" maxlength="6" name="vcm_vnct_pin_cd" value="${ExistVntEdit.vcm_vnct_pin_cd}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Phone Number</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Phone Number" minlength="6" maxlength="15" name="vcm_vnct_ph_no" value="${ExistVntEdit.vcm_vnct_ph_no}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Mobile Number</label>
                      ...
                      <div class="col-md-4">
                    <input type="text"  class="form-control" placeholder="Mobile Number" minlength="10" maxlength="10" name="vcm_vnct_mob_no" value="${ExistVntEdit.vcm_vnct_mob_no}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Email</label>
                  </div>
                      <div class="col-md-4">
                    <input type="email" class="form-control" placeholder="Email" name="vcm_vnct_eml" value="${ExistVntEdit.vcm_vnct_eml}">
                  </div>
                    </div>
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Website</label>
                      ...
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Website" name="vcm_vnct_web" value="${ExistVntEdit.vcm_vnct_web}">
                  </div>
                      <div class="col-md-2">
                    <label class="control-label">Payment Terms</label>
                  </div>
                      <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Payment Terms" name="vcm_vnct_pym_trm" value="${ExistVntEdit.vcm_vnct_pym_trm}">
                  </div>
                    </div>
                      <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Allowed Qty</label>
                      ...
                      <div class="col-md-4">
                    <input type="number" step="any" class="form-control" placeholder="Enter Allowed Qty" name="vcm_alw_qty" value="${ExistVntEdit.vcm_alw_qty}">
                  </div>
                    </div>
               <button style="display:none" type="submit" id="submitterVendorEditForm"></button>
              </form>
                </div>
          </div>
            </div>
