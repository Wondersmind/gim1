      ...
      <ul class="nav navbar-nav navbar-left">
        ...
        <li class="dropdown mega-dropdown active">
          ...
          <ul class="dropdown-menu mega-dropdown-menu row dropwdth">
            ...
            <li class="emplactive"><a href="rawmetrial.mm" class="emplactive">Raw Metrials</a></li>
              </ul>
            </li>
          </ul>
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit Raw Metrial</h4></span>
                                        </div>
                                         
                                       <div class="actions">
                                           
                                             <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddRawEdit()"  id="resrOut" data-toggle="tooltip" title="Save">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" data-toggle="tooltip" title="Delete">
                                             ...
                                             <a class="btn btn-circle btn-icon-only btn-default" href="rawmetrial.mm" id="resrOut" data-toggle="tooltip" title="Existings">
                                ...
                                <form class="form-horizontal" action="saveRawMaterialEdit.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Company Name</label>
                                </div>
                                <div class="col-md-10">
                                <input type="hidden" name="rm_mst_id" value="${ExistRwEdit.rm_mst_id}">
                                 <input type="hidden" name="rm_mst_crt_id" value="${ExistRwEdit.rm_mst_crt_id}">
                                  <input type="hidden" name="rm_mst_crt_dt" value="${ExistRwEdit.rm_mst_crt_dt}">
                                <select class="form-control" name="rm_mst_cmy_cd" required="required">
                               <option value="">Select Company</option>
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                              <c:choose><c:when test="${ExistRwEdit.rm_mst_cmy_cd eq ExistCom.cm_cmy_cd}"> <option value="${ExistCom.cm_cmy_cd}" selected="selected">${ExistCom.cm_cmy_nm}</option></c:when>
                              <c:otherwise> <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option></c:otherwise> </c:choose>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Product Id" name="rm_mst_pdt_id" readonly="readonly" value="${ExistRwEdit.rm_mst_pdt_id}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Product Name" name="rm_mst_pdt_nm" value="${ExistRwEdit.rm_mst_pdt_nm}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Purity" name="rm_mst_pdt_pty"  value="${ExistRwEdit.rm_mst_pdt_pty}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <c:choose><c:when test="${ExistRwEdit.rm_mst_sts eq true}"> <input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled" checked name="rm_mst_sts" >
                                </c:when> <c:otherwise> <input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled"  name="rm_mst_sts" ></c:otherwise> </c:choose>
                             
                                </div>
                                </div>
                                
                                   <button style="display:none" type="submit" id="submitterRawEditForm"></button>
                               <!-- <div class="form-group">
