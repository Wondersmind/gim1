...
<div class="wrapper">
  <div class="container-fluid">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Mold Master</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addmold.mm">
                                                <i class="icon-plus"></i>
                                            </a>
                                         ...
                                         <div class="actions">
                           <c:choose><c:when test="${SaveMoldEditResult eq true}">
    ...
    <tbody>
    <c:forEach var="ExistMold" items="${ExistMoldDet}">
      <tr>
        <td>${ExistMold[0]}</td>
        <td>${ExistMold[1]}</td>
        <td>${ExistMold[2]}</td>
        ...
        <!--<td><label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                     ...
                                                     <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editMoldMstRec(${ExistMold[4]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delMoldMstRec(${ExistMold[4]},this)"><i class="fa fa-trash-o"></i></button>
									</td>
      </tr>
</c:forEach>
    </tbody>
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              { field: '0', caption: 'Cmy Name',type:'text',sortable: true}, 
					             { field: '1', caption: 'Mold No',type:'text', sortable: true},
			                    { field: '2',caption:'Description',type:'text', sortable: true},
		                       { field: '3', caption: 'Status',type:'text', sortable: true},
		                       { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editMoldMstRec(\''+record[4]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delMoldMstRec(\''+record[4]+'\',this)"><i class="fa fa-trash-o"></i></button>';
