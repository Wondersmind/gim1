            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add Department</h4></span>
                                        </div>
                                   
                                       <div class="actions">
                                            
                                             <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddDepartMent()" id="saveOfDptMntBtn" data-toggle="tooltip" title="Save">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="department.mm" id="resrOut" data-toggle="tooltip" title="Existings">
                                               ...
                                               <div class="actions">
                                        <c:choose><c:when test="${SaveDptmntResult eq true}">
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveDepartment.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Code" name="dm_dpt_cd" required="required" value="${dptAutoGnId}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                              ...
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Name" required="required" name="dm_dpt_nm">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <textarea class="taxtare" placeholder="Description" name="dm_dscr"></textarea>
                                </div>
                                </div>
                                <div class="form-group">
                                <div class="col-md-2">
                                ...
                                <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                        <input type="checkbox" class="checkboxes" name="dm_is_fns" >
                                                        <span></span>
                                                    </label>
                                </div>
                                </div>
                                ...
                                <input type="hidden" name="dm_iss_outwd" id="dm_iss_outwd" value="NO">
                                 <div class="col-md-2">
                                <label class="control-label">IS OUTWARD DPT</label>
                                </div>
                                <div class="col-md-10">
                               <input type="checkbox" data-offstyle="danger" data-toggle="toggle" onchange="if(this.checked)$('#dm_iss_outwd').val('YES');else $('#dm_iss_outwd').val('NO');" data-on="YES"  data-off="NOT" >
                              </div>
                                </div>
                                 <button type="submit" id="submiterDepartMentForm" style="display:none"></button>
                                <!--<div class="form-group">
...
function clrInputForAll(){
	$("input,select,textarea").not("input[name=dm_dpt_cd]").val("");$("input[type=checkbox]:first").prop("checked",false);
...
$("form").submit(function(event){
	...
	var dptId=$("input[name='dm_dpt_cd']").val();
	AjaxController.chkThisDptCdAlrdyPrsntOrNot(dptId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
				$("#saveOfDptMntBtn").addClass("disabled");$("#saveOfDptMntBtn").prop("disabled",true);
			document.getElementById("submiterDepartMentForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html(("DepartMentCode Already Used.").fontcolor("red"));
			$("input[name='dm_dpt_cd']").select();
			$("input[name='dm_dpt_cd']").focus();
			return false;
		}
	}
})
