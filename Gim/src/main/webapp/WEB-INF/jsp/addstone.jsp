            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add Stone / Non-Gold</h4></span>
                                        </div>
                                      
                                       <div class="actions">
                                           
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddStone()" id="saveOfStnHBtn" data-toggle="tooltip" title="Save">
                                          ...
                                          <div class="actions">
                                          <c:choose><c:when test="${SaveStoneResult eq true}">
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveStone.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Stone Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Shape Code" name="sm_stn_cd" required="required" value="${stnCdAutoGnId}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                              ...
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Stone Name" required="required" name="sm_stn_nm">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                 <input type="text" class="form-control" placeholder="Shape" name="sm_stn_shpe">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Color" name="sm_stn_clr">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Size" name="sm_stn_sz">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="number" class="form-control" placeholder="Qty" name="sm_stn_qty" step="any" min="0">
                                </div>
                                </div>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Weight" name="sm_stn_wgt" >
                                </div>
                                </div>
                                 <button style="display:none" type="submit" id="submitterStoneForm"></button>
                               <!-- <div class="form-group">
...
function clrInputForAll(){
	$("input,select,textarea").not("input[name=sm_stn_cd]").val("");
...
$("form").submit(function(event){
	...
	var cmyId=$("input[name='sm_stn_cd']").val();
	AjaxController.chkThisStnCdAlrdyPrsntOrNot(cmyId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
				$("#saveOfStnHBtn").addClass("disabled");$("#saveOfStnHBtn").prop("disabled",true);
			document.getElementById("submitterStoneForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html(("StoneCode Already Used.").fontcolor("red"));
			$("input[name='sm_stn_cd']").select();
			$("input[name='sm_stn_cd']").focus();
			return false;
		}
	}
});
