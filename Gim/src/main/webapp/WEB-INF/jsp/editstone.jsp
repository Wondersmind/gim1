      ...
      <ul class="nav navbar-nav navbar-left">
        ...
        <li class="dropdown mega-dropdown active">
          ...
          <ul class="dropdown-menu mega-dropdown-menu row dropwdth">
            ...
            <li class="emplactive"><a href="stone.mm" class="emplactive">Stone/ Non Gold</a></li>
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit Stoe / Non-Gold</h4></span>
                                        </div>
                                      
                                       <div class="actions">
                                           
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddStoneEdit()" id="resrOut" data-toggle="tooltip" title="Save">
                                            ...
                                            <a class="btn btn-circle btn-icon-only btn-default" href="stone.mm" id="resrOut" data-toggle="tooltip" title="Existings">
                                ...
                                <form class="form-horizontal" action="saveStoneEdit.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Shape Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Shape Code" name="sm_stn_cd" readonly="readonly" value="${ExistStnEdit.sm_stn_cd}">
                                <input type="hidden" name="sm_id" value="${ExistStnEdit.sm_id}">
                                    <input type="hidden" name="sm_stn_crt_dt" value="${ExistStnEdit.sm_stn_crt_dt}">
                                        <input type="hidden" name="sm_stn_crt_id" value="${ExistStnEdit.sm_stn_crt_id}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                              ...
                              <c:choose><c:when test="${ExistStnEdit.sm_cmy_cd eq ExistCom.cm_cmy_cd}"> <option value="${ExistCom.cm_cmy_cd}" selected="selected">${ExistCom.cm_cmy_nm}</option></c:when>
                              <c:otherwise> <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option></c:otherwise> </c:choose>
                                ...
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Stone Name</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Stone Name" required="required" name="sm_stn_nm" value="${ExistStnEdit.sm_stn_nm}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                 <input type="text" class="form-control" placeholder="Shape" name="sm_stn_shpe" value="${ExistStnEdit.sm_stn_shpe}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Color" name="sm_stn_clr" value="${ExistStnEdit.sm_stn_clr}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Size" name="sm_stn_sz" value="${ExistStnEdit.sm_stn_sz}">
                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="number" class="form-control" placeholder="Qty" name="sm_stn_qty" step="any" min="0" value="${ExistStnEdit.sm_stn_qty}">
                                </div>
                                </div>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Weight" name="sm_stn_wgt" value="${ExistStnEdit.sm_stn_wgt}">
                                </div>
                                </div>
                                 <button style="display:none" type="submit" id="submitterStoneEditForm"></button>
                               <!-- <div class="form-group">
