    ...
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <div class="panel panel-default">
          <div class="panel-body" style="background: #004274;color: #fff;font-size: 18px;line-height: 40px;  height: -moz-fill-available;  height: -webkit-fill-available;">
            <div class="col-md-12 col-lg-12">
			...
			<div class="w3l">
				<div class="text">
					...
					<p>You have not allow to access this page. Please go to <a href="dashboard.mm">Home Page</a></p>
				</div>
				<div class="image">
