            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="portlet-title">
                      <div class="caption"> <i class="icon-social-dribbble font-dark hide"></i> <span class="caption-subject font-dark bold uppercase text-muted page-title-alt">
                        <h4 class="page-title">Edit Auth Detail</h4>
                        </span> </div>
                          
                                       <div class="actions">
                                           
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddAuth()" id="saveOfMoldHBtn" data-toggle="tooltip" title="Save">
                                                <i class="icon-doc"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:clrInputForAll()" data-toggle="tooltip" title="Delete">
                                                <i class="icon-trash"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="authentication.mm" id="resrOut" data-toggle="tooltip" title="Existings"> <i class="icon-logout"></i> </a> </div>
                    <div class="actions">
                 ...
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                  ...
                  <form class="form-horizontal" action="saveauthentication.mm" id="authform" method="post" enctype="multipart/form-data">
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">Company Name</label>
                  </div>
                      <div class="col-md-10">
                    <select class="form-control" name="auth_cmy_cd" required="required">
                            <option value="">Select Company</option>
                              <c:forEach var="ExistCom" items="${ExistCmyDet}">
                             <c:choose><c:when test="${ExistCom.cm_cmy_cd eq ExistAmHdr.auth_cmy_cd}">
                 ...
                 <input type="hidden" name="auth_id" value="${ExistAmHdr.auth_id}">
                <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">User Name</label>
                  </div>
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="User Name" name="auth_usr_nm" required="required" value="${ExistAmHdr.auth_usr_nm}">
                  </div>
                    </div>
                     <div class="form-group">
                      <div class="col-md-2">
                    <label class="control-label">User Password</label>
                      ...
                      <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="User Password" name="auth_usr_pwd" required="required" value="${ExistAmHdr.auth_usr_pwd}">
                  </div>
                    </div>
              </form>
                </div>
