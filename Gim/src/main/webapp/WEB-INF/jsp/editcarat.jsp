            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Edit CARAT</h4></span>
                                        </div>
                                ...
                                <div class="col-md-8">
                                <label  class="control-label" >${exstCarat_Mst.crtm_carat_cd}</label>
                                <input type="hidden" name="crtm_carat_cd" value="${exstCarat_Mst.crtm_carat_cd}">
                                </div>
                                </div>
                          <input type="hidden" name="crtm_id" value="${exstCarat_Mst.crtm_id}">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Carat Name</label>
                                </div>
                                <div class="col-md-8">
                                <input type="text" class="form-control" placeholder="Carat Name" name="crtm_carat_nm" required="required" value="${exstCarat_Mst.crtm_carat_nm}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-8">
                                 <input type="text" class="form-control" placeholder="Carat Purity" name="crtm_carat_prty" required="required" value="${exstCarat_Mst.crtm_carat_prty}">
                                </div>
                                </div>
                         		 <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-8">
                                 <input type="color" class="form-control" placeholder="Carat Purity" name="crtm_carat_clr" required="required" value="${exstCarat_Mst.crtm_carat_clr}">
                                </div>
                                </div>
                         	 <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-8">
                                 <input type="text" class="form-control" placeholder="Carat wgt" name="crtm_carat_wgt" required="required" value="${exstCarat_Mst.crtm_carat_wgt}">
                                </div>
                                </div>
