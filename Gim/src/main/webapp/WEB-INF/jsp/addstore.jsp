            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add Location</h4></span>
                                        </div>
                                       
                                        <div class="actions">
                                           
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddStore()" id="saveOfStrHBtn" data-toggle="tooltip" title="Save">
                                          ...
                                          <div class="actions">
                                         <c:choose><c:when test="${SaveStoreResult eq true}">
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveStore.mm" method="post">
                <div class="form-group">
                  <div class="col-md-2">
                    <label class="control-label">Code</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Code" name="sm_str_cd" required="required" value="${strAutoGnId}">
                  </div>
                   <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Name" name="sm_str_nm" required="required">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Altr Location Name</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Name" name="sm_alt_str_nm">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 1" name="sm_rgst_nm1">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Register Number 1</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 1" name="sm_alt_rgst_nm1">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 2" name="sm_rgst_nm2">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Register Number 2</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 2" name="sm_alt_rgst_nm2">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Name 3" name="sm_rgst_nm3">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Register Number 3</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Register Number 3" name="sm_alt_rgst_nm3">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Address 1" name="sm_str_ads1">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Address 2</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Address 2" name="sm_str_ads2">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="City" name="sm_str_cty">
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">State</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="State" name="sm_str_st">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <select class="form-control" name="sm_str_cy">
                      <option></option>
                      <option></option>
                      <option></option>
                    </select>
                  ...
                  <div class="col-md-4">
                    <select class="form-control" name="sm_str_cny">
                      <option></option>
                      <option></option>
                      <option></option>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Pin Code" name="sm_str_pin_cd" maxlength="6" minlength="6" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Phone Number</label>
                  </div>
                  <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="Phone Number" name="sm_str_ph_no" onkeypress='return event.charCode >= 48 && event.charCode <= 57' minlength="6" maxlength="15">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4">
                    <input type="text"  class="form-control" placeholder="Mobile Number" name="sm_str_mob_no" maxlength="10" minlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Email</label>
                  </div>
                  <div class="col-md-4">
                    <input type="email" class="form-control" placeholder="Email" name="sm_str_eml">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Website" name="sm_str_web">
                  </div>
                </div>
                  <button style="display:none" type="submit" id="submiterStoreForm"></button>
               <!-- <div class="form-group">
...
function clrInputForAll(){
	$("input,select,textarea").not("input[name=sm_str_cd]").val("");
...
$("form").submit(function(event){
	...
	var cmyId=$("input[name='sm_str_cd']").val();
	AjaxController.chkThisStrCdAlrdyPrsntOrNot(cmyId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
				$("#saveOfStrHBtn").addClass("disabled");$("#saveOfStrHBtn").prop("disabled",true);
			document.getElementById("submiterStoreForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html(("StoreCode Already Used.").fontcolor("red"));
			$("input[name='sm_str_cd']").select();
			$("input[name='sm_str_cd']").focus();
			return false;
		}
	}
});
