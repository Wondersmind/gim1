...
<div class="wrapper">
  <div class="container-fluid">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Stone Master</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addstone.mm">
                                                <i class="icon-plus"></i>
                                            </a>
                                        ...
                                        <div class="actions">
                                          <c:choose><c:when test="${SaveStoneEditResult eq true}">
            ...
            <p style="margin-left: 36%;" class="loadClass" id="LoadName"><b>Loading Please Wait...</b></p>
          	...
          	var tables='${existStoneDetail}'; </script>
    ...
    <tbody>
     <c:forEach var="existStone" items="${existStoneDetail}">
      <tr>
        <td>${existStone[0]}</td>
        <td>${existStone[1]}</td>
        <td>${existStone[2]}</td>
        ...
        <!--<td><label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                     ...
                                                     <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editStoneMstRec(${existStone[6]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delStoneMstRec(${existStone[6]},this)"><i class="fa fa-trash-o"></i></button>
									</td>
</tr></c:forEach>
    </tbody>
  </table> --%>
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              { field: '0', caption: 'Cmy Name',type:'text',sortable: true}, 
					             { field: '1', caption: 'Name',type:'text', sortable: true},
			                    { field: '2',caption:'Shape',type:'text', sortable: true},
		                        { field: '3', caption: 'Colour',type:'text', sortable: true},
		                        { field: '4', caption: 'Size',type:'text', sortable: true},
		                        { field: '5', caption: 'Stone Cd',type:'text', sortable: true},
		                       { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editStoneMstRec(\''+record[6]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delStoneMstRec(\''+record[6]+'\',this)"><i class="fa fa-trash-o"></i></button>';
