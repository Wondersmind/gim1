...
<header id="topnav">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-3">
        ...
        <li class="dropdown mega-dropdown active"> <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Masters</a>
            ...
            <li class="emplactive"><a href="rawmetrial.mm" class="emplactive">Raw Metrials</a></li><li><a href="inoutbom.mm">IN&OUT Bom</a></li>
              </ul>
            </li>
          </ul>
            </li>
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="portlet-title">
                      <div class="caption"> <i class="icon-social-dribbble font-dark hide"></i> <span class="caption-subject font-dark bold uppercase text-muted page-title-alt">
                        <h4 class="page-title">Raw Metrial Master</h4>
                        </span> </div>
                      <div class="actions"> <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut"> <i class="icon-magnifier-remove"></i> </a> <a class="btn btn-circle btn-icon-only btn-default" href="addrawmetrial.mm"> <i class="icon-plus"></i> </a> 
                  ...
                  <div class="actions">
                                           <c:choose><c:when test="${SaveRawEditResult eq true}">
            ...
            <p style="margin-left: 36%;" class="loadClass" id="LoadName"><b>Loading Please Wait...</b></p>
          	...
          	var tables='${existRawDetail}';
               ...
               <%--  <table class="table table-bordered" id="myTable">
                  ...
                  <c:forEach var="existRaw" items="${existRawDetail}">
                    <tr>
                          <td>${existRaw[0]}</td>
                          <td>${existRaw[1]}</td>
                          <td>${existRaw[2]}</td>
                          ...
                          <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editRawMstRec(${existRaw[5]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delRawMstRec(${existRaw[5]},this)"><i class="fa fa-trash-o"></i></button>
									</td>
                        </tr>
       </c:forEach>
                  </tbody>
			 ...
			 var tempStorage=res;
				...
				var columns=[
				              { field: '0', caption: 'Cmy Name',type:'text',sortable: true}, 
					             { field: '1', caption: 'Product Code',type:'text', sortable: true},
			                    { field: '2',caption:'Product Name',type:'text', sortable: true},
		                        { field: '3', caption: 'Purity',type:'text', sortable: true},
		                        { field: '4', caption: 'Status',type:'text', sortable: true},
		                       { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editRawMstRec(\''+record[5]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delRawMstRec(\''+record[5]+'\',this)"><i class="fa fa-trash-o"></i></button>';
