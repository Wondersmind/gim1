            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Add BOM</h4></span>
                                        </div>
                                 
                                       <div class="actions">
                                            
                                             <a class="btn btn-circle btn-icon-only btn-default" href="javascript:saveaddBom()" id="saveOfBomHBtn" data-toggle="tooltip" title="Save">
                 ...
                 <span id="successResult" style="color:green"><div class="alert alert-success">Saved Successfully</div></span>
                                ...
                                <form class="form-horizontal" action="saveBom.mm" method="post">
                                <div class="form-group">
                                 <div class="col-md-2">
                                <label class="control-label">Code</label>
                                </div>
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Code" name="bm_bom_cd" required="required" value="${bomAutoGnId}">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                              ...
                              <c:forEach var="ExistCom" items="${ExistComDet}">
                               <option value="${ExistCom.cm_cmy_cd}">${ExistCom.cm_cmy_nm}</option>
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Name" name="bm_bom_nm" required="required">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                 <input type="text" class="form-control" placeholder="BOM WIP Type" name="bm_bom_wip_typ">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Size" name="bm_bom_sz">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Type" name="bm_bom_typ">
                                </div>
                                </div>
                                  <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="number" step="any" min="0" class="form-control" placeholder="BOM Qty" name="bm_bom_qty">
                                </div>
                                </div>
                                <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="BOM Weight" name="bm_bom_wgt">
                                </div>
                                </div>
                                 <div class="form-group">
                                 <div class="col-md-2">
                                ...
                                <div class="col-md-1">
                                <input type="hidden" name="bm_is_rdy_bom" value="OFF">
                                <input type="checkbox" data-toggle="toggle" data-offstyle="danger" data-on="READY" data-off="NOT READY"  class="form-control" >
                                
                                </div>
                                </div>
                                 <button type="submit" id="submiterBomForm" style="display:none"></button>
                             <!--    <div class="form-group">
...
function clrInputForAll(){
	$("input,select").not("input[name=bm_bom_cd]").val("");
...
$("form").submit(function(event){
	...
	var cmyId=$("input[name='bm_bom_cd']").val();
	AjaxController.chkThisBomCdAlrdyPrsntOrNot(cmyId,rstFun);
	function rstFun(res){
		if(res=="allow"){
			if(frmSub=="dont"){
				frmSub="allow";
				$("#successResult").html("");
			$("#saveOfBomHBtn").addClass("disabled");$("#saveOfBomHBtn").prop("disabled",true);
			document.getElementById("submiterBomForm").click();
			}
			return true;
		}
		else{
			$("#successResult").html(("BomCode Already Used.").fontcolor("red"));
			$("input[name='bm_bom_cd']").select();
			$("input[name='bm_bom_cd']").focus();
			return false;
		}
	}
});
...
$(function() {
    ...
    $(":checkbox").change(function(){
    	$("[name=bm_is_rdy_bom]")[0].value=this.checked?"ON":"OFF";po
   })
  })
</script>
