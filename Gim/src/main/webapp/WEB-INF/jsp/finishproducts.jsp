        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <div class="portlet light bordered">
             <c:choose><c:when test="${saveSucFinshPrcs eq true}">
                 <span id="finalSaveDesinAlert" style="color:green"><div class="alert alert-success" style="text-align:center;">Saved Successfully</div></span>
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Finished Products</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="addfinishproduct.mm">
                                                <i class="icon-plus"></i>
                                            </a>
			 ...
			 var tempStorage=res;
				...
				var columns=[
				             { field: '0', caption: 'Cmy Nm',type:'text', sortable: true},
		                        ...
		                        { field: '2',caption:'Doc No',type:'text', sortable: true},
		                        { field: '12',caption:'Doc Dt',type:'text', sortable: true},
		                        { field: '11', caption: 'Wrk Typ',type:'text', sortable: true},
		                        { field: '3', caption: 'Wrk Nm',type:'text', sortable: true},
		                        { field: '4', caption: 'Tot Qty',type:'text', sortable: true},
		                        { field: '8', caption: 'Tot Acpt',type:'text', sortable: true},
		                        { field: '9', caption: 'Tot Rjct',type:'text', sortable: true},
		                        { field: '5',caption: 'Tot wgt',type:'float', sortable: true},
		                        { field: '13',caption:'Purity',type:'text', sortable: true},
		                        { field: '6',caption: 'Isd Auth',type:'float', sortable: true},
		                      
		                       { field: '9', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='';
				                            	if(record[6]=='1'){
				                            	html='<button type="button" style="width: 48px !important;" class="btn btn-xs btn-default btn-equal"  data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editfnshprcs(\''+record[2]+'\')"><i class="fa fa-pencil"></i></button>';	
				                            	}
				                            	else{
				                            		html='<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editfnshprcs(\''+record[2]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="deletefnshprcshdr(\''+record[2]+'\',this)"><i class="fa fa-trash-o"></i></button>';
													}
				                            	 	return html;
				                            } 
				                        }
...
setTimeout(()=>{
    ...
    function editfnshprcs(dcno){
    	window.location.href="editfinishproduct.mm?fph_dco_no="+dcno+"";
    }
    function deletefnshprcshdr(docNo,ths){
    	$(ths).closest("tr").css("background-color","orangered");
    	var qry="update fnsh_pdt_hdr set fph_sts=0 where fph_doc_no='"+docNo+"' update fnsh_pdt_dtl set fpd_sts=0 where  fpd_doc_no='"+docNo+"'"
    	AjaxController.deletefnshprcshdrDtlAjax(qry,returnResOfDelAlyHdr);
