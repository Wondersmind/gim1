...
<div class="wrapper">
  <div class="container-fluid">
            ...
            <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase text-muted page-title-alt"> <h4 class="page-title">Department Master</h4></span>
                                        </div>
                                        <div class="actions">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="resrOut">
                                                <i class="icon-magnifier-remove"></i>
                                            </a>
                                            <a class="btn btn-circle btn-icon-only btn-default" href="adddepartment.mm">
                                                <i class="icon-plus"></i>
                                            </a>
                                         <a class="btn btn-circle btn-icon-only btn-default" href="javascript:;" id="exporttableDetail" data-toggle="tooltip" title="Export"> <i class="icon-cloud-upload"></i> </a>
                                           ...
                                           <div class="actions">
                                        <c:choose><c:when test="${SaveDptmntEditResult eq true}">
    ...
    <tbody>
     <c:forEach var="existDep" items="${existDepDetls}">
      <tr>
        <td>${existDep[0]}</td>
        <td>${existDep[1]}</td>
        <td>${existDep[3]}</td>
        ...
        <td>${existDep[5]}</td>
                    <td class="text-right">
										<button type="button" class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row" onclick="editDepartmentMstRec(${existDep[2]})"><i class="fa fa-pencil"></i></button>
										...
										<button type="button" class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delDepartmentMstRec(${existDep[2]},this)"><i class="fa fa-trash-o"></i></button>
									</td>
      </tr>
      </c:forEach>
    </tbody>
			...
			res.forEach((obj,index)=> obj['recid']=index);
			 var tempStorage=res;
				...
				var columns=[
			                    ...
			                    { field: '3',caption:'Dept Name',type:'text', sortable: true},
		                        { field: '4', caption: 'Description',type:'text', sortable: true},
		                        { field: '5', caption: 'Status',type:'text', sortable: true},
		                        { field: '8', caption: 'Action',type:'text',
				                            render: function (record, index, column_index) {
				                            	var html='<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-default btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Edit row"  onclick="editDepartmentMstRec(\''+record[2]+'\')"><i class="fa fa-pencil"></i></button>'
				                            		+'&nbsp;<button type="button" ${LoginDet.em_emp_typ} class="btn btn-xs btn-danger btn-equal" data-toggle="tooltip" data-placement="top" data-original-title="Delete row" onclick="delDepartmentMstRec(\''+record[2]+'\',this)"><i class="fa fa-trash-o"></i></button>';
