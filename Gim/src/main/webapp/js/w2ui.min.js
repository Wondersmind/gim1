...
var w2ui = w2ui || {},
    ...
    w2utils = function(a) {
        ...
        function I() {
            ...
            return a("body").append(b), U.scrollBarSize = 100 - a("#_scrollbar_width > div").width(), a("#_scrollbar_width").remove(), String(navigator.userAgent).indexOf("MSIE") >= 0 && (U.scrollBarSize = U.scrollBarSize / 2), U.scrollBarSize
        }
    ...
    function(a) {
        a.fn.w2render = function(b) {
            ...
            function f() {
                ...
                e.css("overflow-y", "auto"), d.height() < b.height() && d.css("height", b.height() + "px")
            }
            var g = this,
                h = "",
                i = {
            ...
            return k.data("element", g.length > 0 ? g[0] : null).data("options", c).data("position", n.left + "x" + n.top).fadeIn("fast").on("click", function(b) {
                ...
                f(), a(document).off(".w2overlay" + h).on("click.w2overlay" + h, e), "function" == typeof c.onShow && c.onShow()
            }, 10), d(), a(this)
            ...
            a.fn._colorAdvanced !== !0 && b.advanced !== !0 || (a("#w2ui-overlay .w2ui-color-tabs :nth-child(2)").click(), a("#w2ui-overlay").removeData("keepOpen")), l({}, !0),
                n(), m();
    ...
    function($) {
        var w2grid = function(a) {
            this.name = null, this.box = null, this.header = "", this.url = "", this.routeData = {}, this.columns = [], this.columnGroups = [], this.records = [], this.summary = [], this.searches = [], this.searchData = [], this.sortData = [], this.postData = {}, this.httpHeaders = {}, this.toolbar = {}, this.stateId = null, this.show = {
                ...
                skipRecords: !0,
                saveRestoreState: !0
            }, this.hasFocus = !1, this.autoLoad = !0, this.fixedBody = !0, this.recordHeight = 24, this.lineNumberWidth = null, this.vs_start = 150, this.vs_extra = 15, this.keyboard = !0, this.selectType = "row", this.multiSearch = !0, this.multiSelect = !0, this.multiSort = !0, this.reorderColumns = !1, this.reorderRows = !1, this.markSearch = !0, this.columnTooltip = "normal", this.disableCVS = !1, this.textSearch = "contains", this.useFieldDot = !0, this.total = 0, this.limit = 100, this.offset = 0, this.style = "", this.ranges = [], this.menu = [], this.method = null, this.recid = null, this.parser = null, this.last = {
                field: "",
                caption: "",
                logic: "OR",
                search: "",
        ...
        $.fn.w2grid = function(a) {
                    ...
                    for (var c = 0, d = 0; d < f.searchData.length; d++) {
                        ...
                        if (null != e) {
                            ...
                            switch (e.operator) {
                                ...
                                case "in":
                                    var m = e.value;
                                    e.svalue && (m = e.svalue), m.indexOf(j) !== -1 && c++, m.indexOf(w2utils.isFloat(i) ? parseFloat(i) : i) !== -1 && c++;
                                    break;
                                case "not in":
                                    var m = e.value;
                                    e.svalue && (m = e.svalue), m.indexOf(j) == -1 && c++, m.indexOf(w2utils.isFloat(i) ? parseFloat(i) : i) == -1 && c++;
                ...
                for (var a = 0, b = this.last.selection, c = 0; c < arguments.length; c++) {
                    ...
                    if (null != e) {
                        ...
                        if ("row" == this.selectType) {
                            ...
                            b.indexes.splice(b.indexes.indexOf(f), 1), g.removeClass("w2ui-selected w2ui-inactive").removeData("selected").find(".w2ui-col-number").removeClass("w2ui-row-selected"), h.removeClass("w2ui-selected w2ui-inactive").removeData("selected").find(".w2ui-col-number").removeClass("w2ui-row-selected"),
                                0 != g.length && (g[0].style.cssText = "height: " + this.recordHeight + "px; " + g.attr("custom_style"), h[0].style.cssText = "height: " + this.recordHeight + "px; " + h.attr("custom_style")), g.find(".w2ui-grid-select-check").prop("checked", !1), a++
                        } else {
            ...
            editChange: function(a, b, c, d) {
                ...
                var o = $(j).find("[col=" + c + "]");
                f || (h.w2ui && h.w2ui.changes && null != h.w2ui.changes[i.field] ? o.addClass("w2ui-changed") : o.removeClass("w2ui-changed"),
                    o.replaceWith(this.getCellHTML(b, c, f))), $(this.box).find("div.w2ui-edit-box").remove(), this.show.toolbarSave && (this.getChanges().length > 0 ? this.toolbar.enable("w2ui-save") : this.toolbar.disable("w2ui-save")), e.last.inEditMode = !1
            },
            delete: function(a) {
                    ...
                    if (setTimeout(function() {
                        ...
                        if (b && ["select", "select-column"].indexOf(b.type) != -1) {
                            ...
                            if (1 == e.reorderRows && e.last.move.reorder) {
                                ...
                                if (i.isCancelled === !0) return $("#grid_" + e.name + "_ghost").remove(), void e.refresh();
            ...
            */},
            ...
            getCellHTML: function(a, b, c, d) {
                ...
                var y = !1;
                return n && $.inArray(b, m.columns[a]) != -1 && (y = !0), g = '<td class="w2ui-grid-data '+(this.columns[b].className||'')+'' + (y ? " w2ui-selected" : "") + " " + l + (j ? " w2ui-changed" : "") + '"    id="grid_' + this.name + "_data_" + a + "_" + b + '" col="' + b + '"    style="' + k + (null != e.style ? e.style : "") + '" ' + (null != e.attr ? e.attr : "") + (d > 1 ? 'colspan="' + d + '"' : "") + ">" + g + "</td>", a === -1 && c === !0 && (g = '<td class="w2ui-grid-data" col="' + b + '" style="height: 0px; ' + k + '" ' + (d > 1 ? 'colspan="' + d + '"' : "") + "></td>"), g
            },
...
function(a) {
    ...
    a.fn.w2sidebar = function(c) {
        ...
        blur: function(b) {
            ...
            return c.isCancelled !== !0 && (this.hasFocus = !1, a(this.box).find(".w2ui-selected").addClass("w2ui-inactive"),
                void this.trigger(a.extend(c, {
                    phase: "after"
                })))
        },
        keydown: function(b) {
                ...
                null == b && (b = d.interval), null == c.tmp.xhr_search && (c.tmp.xhr_search = ""), null == c.tmp.xhr_total && (c.tmp.xhr_total = -1), d.url && a(c.el).prop("readonly") !== !0 && a(c.el).prop("disabled") !== !0 && (0 === d.items.length && 0 !== c.tmp.xhr_total || c.tmp.xhr_total == d.cacheMax && e.length > c.tmp.xhr_search.length || e.length >= c.tmp.xhr_search.length && e.substr(0, c.tmp.xhr_search.length) != c.tmp.xhr_search || e.length < c.tmp.xhr_search.length) && (c.tmp.xhr && c.tmp.xhr.abort(), c.tmp.xhr_loading = !0, c.search(), clearTimeout(c.tmp.timeout), c.tmp.timeout = setTimeout(function() {
                    ...
                    if (g.isCancelled !== !0) {
                        ...
                        d.method && (h.type = d.method), "JSON" == w2utils.settings.dataType && (h.type = "POST", h.data = JSON.stringify(h.data), h.contentType = "application/json"), "HTTPJSON" == w2utils.settings.dataType && (h.data = {
                            ...
                            if (i.isCancelled !== !0) {
                                if (b = i.data, "string" == typeof b && (b = eval(b)), null == b.records && null != b.items && (b.records = b.items, delete b.items), "success" == b.status && null == b.records && (b.records = []), "success" != b.status || !Array.isArray(b.records)) return void console.log("ERROR: server did not return proper structure. It should return", {
                                    status: "success",
                                    records: [{
                                        id: 1,
                                        text: "item"
...
var tableToExcel = (function() {
	 ...
	 var ctx = {worksheet: document.title, table:table}
...
$("#exporttableDetail").click(function(){
	var [header,position]=w2ui['grid'].columns.slice(0,-1).reduce((p,n)=>(p[0]+='<td>'+n.caption+'</td>',p[1].push(n.field),p),['',[]])
	,tbody=w2ui['grid'].records.reduce((p,n)=>{
		let td=position.reduce((x,y)=>(x+=`<td>${/(null|undefined)/i.test(n[y])?'':n[y]}</td>`),'');
		p+='<tr>'+td+'</tr>';
		return p;
	},"<tr style='background-color: #004274;color:#ffffff'>"+header+"</tr>");
